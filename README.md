...
```json
{
  "plugin": ["@mathew-cf/opencode-terminal-notifier@0.1.5"]
}
```
...
Inspired by [opencode-notifier](https://github.com/mohak34/opencode-notifier). This plugin uses terminal-native notifications instead of AppleScript/osascript, so clicking a notification activates the specific terminal session that created it.
