...
Inspired by [opencode-notifier](https://github.com/AldoRD/opencode-notifier). This plugin uses terminal-native notifications instead of AppleScript/osascript, so clicking a notification activates the specific terminal session that created it.
